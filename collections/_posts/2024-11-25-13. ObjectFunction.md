...
빈 객체를 생성한 이후 [프로퍼티](#) 또는 [메서드](#)를 추가하여 객체를 완성할 수 있다. <br>
...
<br>🤓 Q.  `Object` 생성자 함수를 사용해 객체를 생성하는 방식은 유용하다고 볼 수 있는가?
...
{% include framework/shortcodes/figure.html src="/assets/images/gen/content/post_13/constructor.webp" title="constructor and nonconstruct description" caption="Ungmo Lee. (2020). Modern Javascript DeepDive. wikibooks. p.243." alt="Photo of constructor and non-consctructor explanation" link="" target="" %}
