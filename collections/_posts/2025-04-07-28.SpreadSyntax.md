...
- ### ① [스프레드 문법](#1-스프레드-문법)
  ...
  - [1.1 함수 호출문의 인수목록에서 사용](#11-함수-호출문의-인수목록에서-사용)
  - [1.2 배열 리터럴 내부에서 사용하는 경우](#12-배열-리터럴-내부에서-사용하는-경우)
    - [1.2.1 concat의 역할을 대체](#121-concat의-역할을-대체)
    - [1.2.2 splice의 역할을 대체](#122-splice의-역할을-대체)
    - [1.2.3 slice로 배열 복사](#123-slice로-배열-복사)
    - [1.2.4 이터러블을 배열로 변환](#124-이터러블을-배열로-변환)
  - [1.3 객체 리터럴 내부에서 사용하는 경우](#13-객체-리터럴-내부에서-사용하는-경우)
