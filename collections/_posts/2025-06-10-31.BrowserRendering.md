...
### ① [렌더링 과정](#1-렌더링-과정--브라우저는-어떠한-과정을-거쳐서-렌더링을-진행할까)

- [1.1 요청과 응답](#11-요청과-응답)
- [1.2 HTTP-10과-HTTP-20](#12-http-10과-http-20)
- [1.3 렌더트리 생성](#13-렌더트리-생성)

### ② [자바스크립트 파싱과 HTML 파싱 중단](#2-자바스크립트-파싱과-html-파싱-중단)

- [2.1 DOMContentLoaded 이벤트 사용](#21-domcontentloaded-이벤트-사용)
- [2.2 body 하단에 script 배치](#22-body-하단에-script-배치)
- [2.3 async 어트리뷰트](#23-async-어트리뷰트)
- [2.4 defer 어트리뷰트](#24-defer-어트리뷰트)
